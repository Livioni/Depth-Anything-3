# ======================================================
# DAN Training Configuration (Small + Scale Head)
# ======================================================

# == Common Configuration ==
output_dir = "outputs"
exp_name = "DAN-Small-test"
logging_dir = "logs"
...
# == Model Configuration ==
model_config = "src/depth_anything_3/configs/da3-small-metric.yaml"
model_checkpoint_path = "checkpoints/da3-small/model.safetensors"
...
train_dataset = f" 100 @ Scannetppv2(use_cache = True, quick = False, top_k = 32, dset='', z_far = 50, aug_crop=16, resolution={resolution}, transform=ColorJitter, seed=985)"
