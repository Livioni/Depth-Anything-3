...
class Spring(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='<here is your dataset location>',  # for example /mnt/local/lihao/phs_datasets/spring
                 dset='',
                 use_cache=False,
                 use_augs=False,
                 top_k=256,
        ...
        if self.use_cache:
            anno_root = '<here is your annotation path>'  # for example /mnt/local/lihao/phs_datasets/annotations/spring_annotations
            ...
            for seq in self.sequences:
                ...
                for anno in cam_files:
                    ...
                    assert intr.shape == (3, 3), f'Intrinsics shape mismatch in {anno}: {intr.shape}'
...
if __name__ == "__main__":
    ...
    def visualize_scene(idx, out='spring_scene.glb'):
        views = dataset[idx]
        viz = SceneViz()
