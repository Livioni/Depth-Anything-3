...
class Colosseum(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='<here is your dataset location>',  # for example /mnt/local/lihao/phs_datasets/colosseum
                 dset='',
                 use_cache=False,
                 use_augs=False,
                 top_k=256,
        ...
        if self.use_cache:
            dataset_location = '<here is your annotation path>'  # for example /mnt/local/lihao/phs_datasets/annotations/colosseum_annotations
