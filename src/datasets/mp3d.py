...
class Mp3d(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='<here is your dataset location>',  # for example /mnt/local/lihao/phs_datasets/mp3d
                 dset='',
                 use_cache=False,
                 use_augs=False,
                 top_k=256,
        ...
        if self.use_cache:
            anno_root = '<here is your annotation path>'  # for example /mnt/local/lihao/phs_datasets/annotations/mp3d_annotations
...
if __name__ == "__main__":
    ...
    def visualize_scene(idx, out='mp3d_scene.glb'):
        views = dataset[idx]
        viz = SceneViz()
