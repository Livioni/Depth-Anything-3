...
class Mp3d(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='/mnt/local/lihao/phs_datasets/mp3d',
                 dset='',
                 use_cache=False,
                 use_augs=False,
                 top_k=256,
        ...
        if self.use_cache:
            anno_root = '/mnt/local/lihao/phs_datasets/annotations/mp3d_annotations'
            ...
            # 默认禁用，cache 已离线生成
            # anno_root = f'/mnt/local/lihao/phs_datasets/annotations/mp3d_annotations/{dset}'
