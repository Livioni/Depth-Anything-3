...
class RLBench(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='<here is your dataset location>',  # for example /mnt/local/lihao/phs_datasets/rlbench
                 dset='',
                 use_cache=False,
                 use_augs=False,
                 top_k=256,
        ...
        print('loading RLBench dataset...')
        super().__init__(*args, **kwargs)

        # Initialize instance attributes
        self.dataset_label = 'RLbench'
        ...
        if self.use_cache:
            dataset_location = '<here is your annotation path>'  # for example /mnt/local/lihao/phs_datasets/annotations/rlbench_annotations
