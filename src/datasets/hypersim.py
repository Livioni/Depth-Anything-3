...
broken_scenes = [
    'ai_003_001', 'ai_004_009', 'ai_015_006', 'ai_038_007', 'ai_046_001',
    'ai_046_009', 'ai_048_004', 'ai_053_005', 'ai_012_007', 'ai_013_001',
    'ai_023_008', 'ai_026_020', 'ai_023_009', 'ai_023_004', 'ai_023_006',
    'ai_026_013', 'ai_026_018',
]
        ...
        if self.use_cache:
            ...
            for seq in self.sequences:
                ...
                for sub_seq in sorted(os.listdir(seq)):
                    ...
                    cam_files = sorted(glob.glob(os.path.join(sub_path, '*_cam.npz')))
                    ...
                    for anno in cam_files:
                        ci = np.load(anno)
                        pose = np.array(ci['pose'], dtype=np.float32)
...
if __name__ == "__main__":
    ...
    def visualize_scene(idx, out='hypersim_scene.glb'):
        views = dataset[idx]
        viz = SceneViz()
